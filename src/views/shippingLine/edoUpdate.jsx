...
export default class EdoUpdate extends Component {
  constructor(props) {
    super(props);
    this.state = {
      formData: {
  ...
  render() {
    return (
      <Content className="flex_layout-8-16_container edoUpdate_layout">
        <Row gutter={[12, 12]}>
          <Col lg={{ span: 8 }} sm={{ span: 24 }}>
            <Mcard title={<span style={{ color: "white" }}>Cập nhật EDO</span>}>
