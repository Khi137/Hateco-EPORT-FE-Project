    ...
    handleLoadData = () => {
        ...
        setTimeout(() => {
            if (this.submitButtonRef.current) {
                ...
                this.setState((prevState) => ({
                    generalInformation: this.rowData[0] && this.rowModalData[0] ? this.rowData[0] && this.rowModalData[0] : {},
            ...
            <Content className='flex_layout-8-16_container' >
                <Row gutter={[12, 12]}>
                    ...
                    <Col lg={{ span: 16 }} sm={{ span: 24 }}>
                        <Mcard
                            title={<span style={{ color: 'white' }}>Bảng báo cáo doanh thu hoá đơn thu ngay (DTP)</span>}
                        >
                            {!this.state.isLoading ? (
...
export default InstantInvoiceWithReleasePointReport
