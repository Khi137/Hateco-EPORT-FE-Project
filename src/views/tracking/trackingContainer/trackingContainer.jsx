...
class TrackingContainer extends Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        if (prevState.formData.containerIndex !== this.state.formData.containerIndex) {
    ...
    handleSetIndex = (type) => {
        let updatedValue = Number(typeof this.state.formData.containerIndex !== "string" ? this.state.formData.containerIndex : this.state.formData.containerPrevIndex)
    ...
    getDataForm = (container) => {
        const dataList = [
            ...
            {
                title: "Vị trí",
                value: container ? container?.Block + "-" + container?.Bay + "-" + container?.Row + "-" + container?.Tier : "",
                className: "location"
            },
            {
                title: "Ngày ra bãi",
                                ...
                                <Col className="have_data">
                                    <Row className="table_index_container">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => this.handleChangeIndex(e, /^[0-9\-\+]{0,3}$/)}
                                        />
                                        <div>{" / " + this.state.containerList.length}</div>
                                        <Mbutton className="next_index_button m_button outlet"
                                            dataSource={{
                                                textbutton: ">"
                                            }}
