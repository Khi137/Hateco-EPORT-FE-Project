...
class TrackingContainer extends Component {
  ...
  getDataForm = (container) => {
    const dataList = [
      ...
      },
      {
        title: "ETB/ETD",
        value:
          formatDateTime(container?.VETB) +
          " / " +
          formatDateTime(container?.VETD),
      },
      {
        title: "Full/Empty",
  ...
  renderDataTable = (container) => {
    const tableIndex =
      typeof this.state.formData.containerIndex !== "string"
        ? this.state.formData.containerIndex - 1
        : this.state.formData.containerPrevIndex - 1;
    ...
    return (
      <Row className="tracking-container_container">
        <div className="content">
          <Row className="header body-md-normal">Tra cứu số container</Row>
          ...
          <div
            className={`table_content ${
              containerList.length !== 0 && "table_exist_data"
            }`}
          >
